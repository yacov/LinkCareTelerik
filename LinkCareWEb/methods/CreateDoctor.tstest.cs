...
namespace LinkCareWEb
{
    ...
    public class CreateDoctor : BaseWebAiiTest
    {
        ...
        //[CodedStep(@"Execute test 'GenerateData'")]
        //public void CreateDoctor_CodedStep()
        //{
            //// Execute test 'GenerateData'
            //this.ExecuteTest("methods\\GenerateData.tstest");
            
        //}
    
        //[CodedStep(@"GenerateData")]
        //public void CreateDoctor_CodedStep1()
        //{
            ...
            //SetExtractedValue("generatedID", personalId);
             ...
             //int numteacher = random.Next(9999, 99999);
                        ...
                        //string dataSourcePath = this.ExecutionContext.DeploymentDirectory + @"\Data\Var1.xlsx";
            //string myPath = "C:\\Development\TelerikAutomationLinkCare\Var1.xlsx";
